...
exports.totalOrderPriceIntoDB =
  exports.ordersPriceSumDB =
  exports.addOrderUserInDB =
  exports.specificUserOrdersDB =
  exports.updateUsersDB =
  exports.deleteSigleUsersDB =
  exports.getSigleUsersDB =
  exports.getAllUsersDB =
  exports.creatUserInDB =
    void 0;
const user_model_1 = require("./user.model");
//main marks
const creatUserInDB = (user) =>
...
const updateUsersDB = (id, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_model_1.UserModel.updateOne(
      { userId: { $eq: id } },
      { $set: data }
    );
    return result;
...
//bonus marks
const specificUserOrdersDB = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userOrders = yield user_model_1.UserModel.findOne(
      { userId: { $eq: id } },
      { _id: 0, orders: 1 }
    );
    return userOrders;
...
const addOrderUserInDB = (id, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_model_1.UserModel.updateOne(
      { userId: id },
      { $push: { orders: data } }
...
const totalOrderPriceIntoDB = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
